...
static void YGApplyLayoutToViewHierarchy(UIView *view, BOOL preserveOrigin)
{
  ...
  view.frame = (CGRect) {
    ...
    .size = {
      .width = isnan(YGRoundPixelValue(bottomRight.x) - YGRoundPixelValue(topLeft.x)) ? 0: YGRoundPixelValue(bottomRight.x) - YGRoundPixelValue(topLeft.x),
      .height = isnan(YGRoundPixelValue(bottomRight.y) - YGRoundPixelValue(topLeft.y)) ? 0: YGRoundPixelValue(bottomRight.y) - YGRoundPixelValue(topLeft.y),
    },
  };
